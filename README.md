...
| `abertura`         | LocalTime | Horário de abertura  do espaço                   |
| `fechamento`       | LocalTime | horário de fechamento do espaço                 |
...
| `inicio`  | LocalDateTime                                                               | Início da reserva |
| `fim`     | LocalDateTime                                                               | Fim da reserva |
| `status`  | Enum (PENDENTE, CONFIRMADA, CANCELADA, FINALIZADA, NEGADA, NAO_COMPARECEU ) | Estado da reserva |
...
- Apenas **administradores** podem:
  ...
  - Alterar o status da reserva em casos, como: CONFIRMADA, NEGADA, NAO_COMPARECEU.
  - Visualizar de todas as reservas.
...
| `GET`    | `/espaco`             | Listar todos os espaços                |
| `POST`   | `/espaco`             | Criar espaço (ADMIN)                   |
| `DELETE` | `/espaco/{id}`        | Remover espaço (ADMIN)                 |
| `POST`   | `/reserva`            | Criar reserva                          |
| `GET`    | `/reserva`            | Listar todas as reservas (ADMIN)       |
| `GET`    | `/reserva/{id}`       | Listar reservas do usuário autenticado |
| `PATCH`  | `/reserva/usuario/{id}` | Atualizar reserva (USUARIO)            |
| `PATCH`  | `/reserva/adm/{id}`   | Atualizar reserva (ADMIN)              |
---
